...
if($action == 'show'){  
    ...
    $sql="select *,(select count(AID) from tblearstudent where 
     EARYearID={$yearid} and GradeID=g.AID) as count
    from tblgrade g where AID is not null order by AID desc 
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        <tr>
            ...
            <th>'.$lang["eargrade_stucount"].'</th>
            <th width="20%;" class="text-center">Add Fee</th>           
        </tr>
        </thead>
        <tbody>
        ';
        ...
        $sql_total="
        select *,(select count(AID) from tblearstudent where 
         EARYearID={$yearid} and GradeID=g.AID) as count
        from tblgrade g where AID is not null order by AID desc";
        ...
        <tr>
            ...
            <th>'.$lang["eargrade_title"].'</th>
            <th>'.$lang["eargrade_stucount"].'</th>
            <th width="20%;" class="text-center">'.$lang["eargrade_stuadd"].'</th>           
        </tr>
        </thead>
        <tbody>
            <tr>
